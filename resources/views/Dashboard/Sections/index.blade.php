...
@section('page-header')
				...
				<div class="breadcrumb-header justify-content-between">
					<div class="my-auto">
						<div class="d-flex">
							<h4 class="content-title mb-0 my-auto mr-1">Dashboard</h4><span class="text-muted mt-1 tx-15 mr-2 mb-0">/ sections</span>
						</div>
					</div>
				</div>
				<!-- breadcrumb -->
                                    ...
                                    <div class="table-responsive">
                                        <table class="table text-md-nowrap" id="example2">
                                            ...
                                            <tr>
                                                ...
                                                <th class="wd-35p border-bottom-0">description</th>
                                           ...
                                           @foreach($sections as $section)
                                               <tr>
                                                ...
                                                <td class=" text-dark" >{{$section->name}}</td>
                                                   <td class=" text-secondary" >{{$section->description}}</td>
