                        ...
                        <table style="text-align: center" class="table text-md-nowrap" id="example1">
                            <thead>
                                <tr>
                                    ...
                                    <th>description</th>
                                    <th> doctor</th>
                                    <th>lab employee name</th>
                                    <th> description lab employee</th>
                                    <th>processes</th>
                                </tr>
                            </thead>
                            <tbody>
                                @foreach ($labs as $lab)
                                    <tr>
                                        ...
                                        <td class="{{ !$lab->description_employee ? 'text-warning' : '' }}">
                                            {{ $lab->employee->name ?? 'Not determined yet' }}</td>
                                        <td class="{{ !$lab->description_employee ? 'text-warning' : '' }}">
                                            {{ $lab->description_employee ?? 'Soon to be determined' }}</td>
                                        <td>
