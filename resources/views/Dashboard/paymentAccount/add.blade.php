...
@section('page-header')
    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex">
                <h4 class="content-title mb-0 my-auto">Accounts</h4><span class="text-muted mt-1 tx-15 ml-1 mb-0">/ Add A New Payment</span>
            </div>
        </div>
    </div>
    <!-- breadcrumb -->
...
@include('Dashboard.layouts.messages_notif')
    ...
    <div class="row">
        <div class="col-lg-12 col-md-12">
            <div class="card">
                <div class="card-body">
                    <form action="{{ route('paymentAccount.store') }}" method="post" autocomplete="off" enctype="multipart/form-data">
                       @csrf
