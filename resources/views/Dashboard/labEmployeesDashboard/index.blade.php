...
@section('page-header')
    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="left-content">
            <div>
                <h2 class="main-content-title tx-24 mg-b-1 mg-b-lg-1">Welcome Back Lab Employees : <span
            ...
            <div class="card overflow-hidden sales-card bg-primary-gradient">
                <div class="pl-3 pt-3 pr-3 pb-2 pt-0">
                    ...
                    <div class="pb-0 mt-0">
                        <div class="d-flex">
                            <div class="">
                                <h4 class="tx-20 font-weight-bold mb-1 text-white">{{ App\Models\Lab::count() }}</h4>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="d-flex">
                            <div class="">
                                <h4 class="tx-20 font-weight-bold mb-1 text-white">
                                    {{ App\Models\Lab::where('status', 0)->count() }}</h4>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="pl-3 pt-3 pr-3 pb-2 pt-0">
                    ...
                    <div class="pb-0 mt-0">
                        <div class="d-flex">
                            <div class="">
                                <h4 class="tx-20 font-weight-bold mb-1 text-white">
                                    {{ App\Models\Lab::where('status', 1)->count() }}</h4>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="card card-table-two">
                ...
                <div class="table-responsive country-table">
                    <table class="table table-striped table-bordered mb-0 text-sm-nowrap text-lg-nowrap text-xl-nowrap">
                        ...
                        <tbody>
                            @forelse(\App\Models\Lab::latest()->take(5)->get() as $invoice)
                                <tr>
