...
@section('page-header')
    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex">
                <h4 class="content-title mb-0 my-auto">Labs</h4><span class="text-muted mt-1 tx-15 ml-1 mb-0">/ List</span>
            </div>
        </div>
    </div>
    <!-- breadcrumb -->
                                            ...
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu tx-13">
                                                    <a class="dropdown-item"
                                                        href="{{ route('labEmp.edit', $lab->id) }}"><i
                                                            class="text-primary fa fa-stethoscope"></i>&nbsp;&nbsp;Add the Analysis result
                                                         </a>
                                                </div>
                                            </div>
                                        </td>
