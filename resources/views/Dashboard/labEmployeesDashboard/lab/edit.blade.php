...
@section('page-header')
    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex">
                <h4 class="content-title mb-0 my-auto"> Analysis result : <span class="text-success tx-20 mb-0">{{ $lab->patient->name }}</span></h4>
            </div>
        </div>
    </div>
    <!-- breadcrumb -->
...
@include('Dashboard.layouts.messages_alert')
    <div class="row">
        <div class="col-lg-12 col-md-12">
            <div class="card">
                <div class="card-body">
                    <form action="{{route('labEmp.update',$lab->id)}}" method="post" enctype="multipart/form-data">
                        @csrf
